...
public class OBDomesticVRPResponseTestDataFactory3_1_10 {
    ...
    public static OBDomesticVRPResponseData aValidOBDomesticVRPResponseData(OBDomesticVRPRequest request) {
        return (new OBDomesticVRPResponseData())
                ...
                .initiation(OBDomesticVRPCommonTestDataFactory.aValidOBDomesticVRPInitiation3_1_10())
                .instruction(OBDomesticVRPRequestTestDataFactory.aValidOBDomesticVRPInstruction3_1_10())
